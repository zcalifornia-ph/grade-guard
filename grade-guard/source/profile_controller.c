...
Apache License
   ...
   Copyright 2024  Zildjian E. California
                   Ravhen M. Grageda
                   Charisse C. Lorejo
...
Interactive profile management flow for collecting input and navigating profile actions.
